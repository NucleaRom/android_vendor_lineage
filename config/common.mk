...
# This is Lineage (with some NucleaRom stuff)!
PRODUCT_COPY_FILES += \
...
# NucleaRom bootanimation
ifeq ($(TARGET_BOOT_ANIMATION_RES),720)
     PRODUCT_COPY_FILES += vendor/lineage/bootanimation/720.zip:system/media/bootanimation.zip
else ifeq ($(TARGET_BOOT_ANIMATION_RES),1080)
     PRODUCT_COPY_FILES += vendor/lineage/bootanimation/1080.zip:system/media/bootanimation.zip
else ifeq ($(TARGET_BOOT_ANIMATION_RES), 1440)
     PRODUCT_COPY_FILES += vendor/lineage/bootanimation/1440.zip:system/media/bootanimation.zip
else
     PRODUCT_COPY_FILES += vendor/lineage/bootanimation/1080.zip:system/media/bootanimation.zip
endif
...
# NucleaRom versioning
NR_VERSION_TAG := 9
NR_VERSION_TYPE := $(NR_VERSION_TAG)-$(NR_TYPE)
ROM_POSTFIX := $(shell date -u +%Y%m%d)

NR_VERSION := $(NR_VERSION_TYPE)-$(LINEAGE_BUILD)-$(ROM_POSTFIX)
NR_DISPLAY_VERSION := $(NR_VERSION)
