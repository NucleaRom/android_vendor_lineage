...
ALARM_PATH := vendor/nr/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/nr/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/nr/prebuilt/common/media/audio/ringtones
